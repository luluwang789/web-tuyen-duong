            ...
            <header class="panel-heading">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="position-center">
                            <form action="{{route('save-year')}}" method="post" class="form-horizontal" role="form">
                                {{csrf_field()}}
                                <div class="form-group">
                                    <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">Năm học: </label>
                                    <div class="col-lg-10">
                                        <input type="text" name="name_year" class="form-control" placeholder="2019-2020" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">Hiển thị: </label>
                                    <div class="col-lg-10">
                                        <select name="status_year" id="" class="form-control">
